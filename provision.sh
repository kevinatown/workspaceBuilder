...
sudo apt-get -y install git libyaml-dev libxslt-dev libxml2-dev nodejs nodejs-dev coffeescript
# other packages 
# libsqlite3-dev postgresql postgresql-contrib libpq-dev python-pip apache2 mysql-server php5-mysql python-dev 
...
#
~/.rvm/bin/rvm --quiet-curl install ruby-2.3.1
